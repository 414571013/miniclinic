...
INSERT OR IGNORE INTO doctor (doctor_id, name, department, specialty, password_hash) VALUES
    ('D001', '陳志明醫師', '家醫科', '一般內科、慢性病管理','$2a$10$q/8IWOHu9YoUayGcd3znZekIpIZkDn0V2A8bFod18ylQ4cyPhhDFi'),
    ('D002', '林佩君醫師', '內科',   '心臟血管、高血壓', '$2a$10$q/8IWOHu9YoUayGcd3znZekIpIZkDn0V2A8bFod18ylQ4cyPhhDFi'),
    ('D003', '王建華醫師', '復健科', '運動傷害、脊椎復健', '$2a$10$q/8IWOHu9YoUayGcd3znZekIpIZkDn0V2A8bFod18ylQ4cyPhhDFi'),
    ('D004', '李美玲醫師', '小兒科', '兒童感冒、疫苗接種',  '$2a$10$q/8IWOHu9YoUayGcd3znZekIpIZkDn0V2A8bFod18ylQ4cyPhhDFi'),
    ('D005', '張雅筑醫師', '身心科', '焦慮、失眠、情緒調適', '$2a$10$q/8IWOHu9YoUayGcd3znZekIpIZkDn0V2A8bFod18ylQ4cyPhhDFi'); -- 123456
